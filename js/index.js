...
function hideBtn(){
  ...
  content.innerHTML = "<p>你好: </p> <p> &nbsp;&nbsp;&nbsp;&nbsp;我很奇怪你为什么主动给我发张好人卡,我又没有跟你表白或者要求什么,我只是需要一个符号或者象征什么的<br/> </p> <p> &nbsp;&nbsp;&nbsp;&nbsp;我跟你聊了挺长时间了,算是大概有个了解吧,有时候挺替你担心的,(此处应有说教),但是并没有,道理不是真理,所以不能套用在每个人身上.&nbsp; 最后,并不想问你是正爱慕谁/等待谁/或者干脆单身主义,只希望你能幸福吧. </p> <p> &nbsp;&nbsp;&nbsp;&nbsp;一个小小建议,有人让我明白了一个刻骨铭心的道理那就是:要现实,so我觉得单身主义不适合你的,去试着主动接触你喜欢的人吧,记住啊 最是人间留不住,美人辞镜花辞树,要珍惜时光.<br/> </p> <p> &nbsp;&nbsp;<br/> </p>"
}
